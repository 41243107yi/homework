...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/images/images/new.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionNew->setIcon(icon);
        actionOpen = new QAction(MainWindow);
        actionOpen->setObjectName("actionOpen");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/images/images/open.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/images/images/save.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSave->setIcon(icon2);
        actionAS = new QAction(MainWindow);
        actionAS->setObjectName("actionAS");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/images/images/asave.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/images/images/undo.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionUndo->setIcon(icon4);
        actioncuT = new QAction(MainWindow);
        actioncuT->setObjectName("actioncuT");
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/images/images/cut.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actioncuT->setIcon(icon5);
        actionCopy = new QAction(MainWindow);
        actionCopy->setObjectName("actionCopy");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/images/images/copy.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icons/images/images/paste.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
...
#endif // QT_CONFIG(shortcut)
        actionClose->setText(QCoreApplication::translate("MainWindow", "\351\227\234\351\226\211(&E)", nullptr));
#if QT_CONFIG(tooltip)
        actionClose->setToolTip(QCoreApplication::translate("MainWindow", "\351\227\234\351\226\211\346\252\224\346\241\210", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        actionClose->setShortcut(QCoreApplication::translate("MainWindow", "Ctrl+E", nullptr));
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(tooltip)
        actionUndo->setToolTip(QCoreApplication::translate("MainWindow", "\351\202\204\345\216\237\346\252\224\346\241\210", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
